...
import com.tecsup.jwa.modelo.Usuario;
...
public class UsuarioRegistroValidacionController {
	...
	public ModelAndView iniciar() {
		...
		ModelAndView modelAndView = new ModelAndView("registroValidacion/formulario", "usuario", new Usuario());

		return modelAndView;
	}

	@PostMapping("/crear")
	public String crear(@Validated @ModelAttribute("usuario") Usuario usuario, BindingResult bindingResult,
			ModelMap model) {
